...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVerificationView = (EditText) findViewById(R.id.verification);
    ...
    private void attemptLogin() {
        ...
        editor.putString("authenticated", "no");
        editor.commit();
    ...
    private void attemptRegister() {
        ...
        String verification = mVerificationView.getText().toString();
        SharedPreferences userInfo = getSharedPreferences("user",0);
        SharedPreferences.Editor editor = userInfo.edit();
        editor.putString("email",email);
        editor.putString("password",password);
        ...
        if (!TextUtils.isEmpty(verification)) {
            ...
            cancel = true;
        } else if(!verification.equals("WEARETARTUTORS")){
            mVerificationView.setError(getString(R.string.error_verify_failed));
            focusView = mVerificationView;
            cancel = true;
        }
                    ...
                    ref.child("users").child(authData.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot snapshot) {
                            ...
                            if (((String)(checkIfTutor.get("id"))).equals("tutor")){
                                ...
                                mEmailView.setError(getString(R.string.error_not_tutor));
